...
const menuClickCallback = function(e = null) {
...
$(document).on("click", ".metismenu li a, .navbar-nav  li a", menuClickCallback);

function call_ajax_page(page) {

	if(page === "index.html")
	{
		document.title = "Dashboard | SPEEL SOLAR - CMS";
	}
	else
	{
		var title = page;
		var title1 = title.replace("-", " ");
		document.title = title1.charAt(0).toUpperCase() + title1.slice(1) + " | SPEEL SOLAR - CMS";
	}
